...
class MultipleServers(InfraSpec):
  ...
  gateway = RouterGateway("actuator_ex2_gateway", ctxt.infra.router,
                          "external")
  rinter = RouterInterface("actuator_ex2_rinter", ctxt.infra.router,
                           ctxt.infra.subnet)
  #
...
class MultipleGroups(InfraSpec):
  ...
  gateway = RouterGateway("actuator_ex3_gateway", ctxt.infra.router,
                          "external")
  rinter = RouterInterface("actuator_ex3_rinter", ctxt.infra.router,
                           ctxt.infra.subnet)
  #
  #now declare the "foreman"; this will be the only server the outside world can
